...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "INSERT INTO anggota (nama, alamat, no_hp) VALUES ('$nama', '$alamat', '$no_hp')");
...
<div class="main">
    ...
    <h3 class="fw-bold text-dark mb-4">Tambah Anggota Baru</h3>
    ...
    <div class="form-card">
        <form method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat lengkap saat ini" required></textarea>
            </div>
